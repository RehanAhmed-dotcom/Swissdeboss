...
const Services_Detail = ({navigation}) => {
  ...
  const _FetchAppointmentsAPiPending = () => {
    ...
    AllGetAPI({url: 'pending_app', Token: user?.api_token})
      .then(res => {
        // setIsLoading(false);
        setPendingData(res.pending_appointments);
        console.log(
          'Appointment Data _Fetch   AppointmentsAPiPending=================',
          res,
        );
      })
      .catch(err => {
      ...
      <View
        ...
        <ScrollView>
          <View style={styles.header}>
            ...
            <Text style={styles.headerText}>New Appointments</Text>
            <View></View>
          </View>
